...
# About the project
I used HTML, CSS, Javascript and Bootstrap! I link api keys to retreive data about the weather. I also created anopenweather account to generate my api key.

# Screenshot
![alt text](./images/WeatherBoard.png)
